...
static const char col_gray3[]       = "#b8d0d9";
static const char col_gray4[]       = "#0b0f10";
static const char col_cyan[]        = "#a7c1d0";
...
// volume
static const char *upvol[]   = { "amixer", "-q", "set", "PCM", "5%+", "unmute", NULL };
static const char *downvol[] = { "amixer", "-q", "set", "PCM", "5%-", "unmute", NULL };
